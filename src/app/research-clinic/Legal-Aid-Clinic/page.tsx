...
const LegalAidClinic = () => {
  const { cases: activities, loading, error, refreshCases } = useLegalAid();
                    ...
                    {activities.map((caseItem, idx) => (
                      ...
                      >
                        <div className="md:w-30 h-28 relative rounded overflow-hidden flex-shrink-0">
                          <Image
                            src={caseItem.image || "/assets/Noimage.jpg"}
                            alt={caseItem.title}
                            fill
