...
const GenderLAWCLINICpage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 mt-32">
      {/* HERO SECTION */}
      <header className="relative w-full min-h-[110vh] sm:min-h-[120vh] md:min-h-[130vh] lg:min-h-[60vh] overflow-hidden">
        <Image
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <section id="activities" className="space-y-6 lg:col-span-12 py-5">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ul className="list-disc mt-2 pl-6 space-y-3 text-gray-700">
                  <li><span className="font-bold">
                    ...
                    Students gain practical skills in client interviewing, legal research, drafting legal documents, and courtroom representation, moving beyond abstract classroom teaching to "law in action".</li>

                  <li><span className="font-bold">
                    Fostering Social Consciousness:</span>
                    The direct engagement with communities and victims of injustice helps students reflect on their own privileges and their professional responsibility to public service and social justice.</li>

                  <li><span className="font-bold">
                    Challenging Systemic Bias: </span>
                    Clinics actively work to address the "gender-biased" and "gender-insensitive" laws and judgments that persist within the legal system, advocating for a more equitable and inclusive justice system.</li>

                  <li><span className="font-bold">
                    Generating Knowledge:</span>
            ...
            <div className="rounded-xl p-8 bg-white shadow-xl mb-10">
              <h4 className="text-xl font-semibold text-purple-600 mb-4">
                Challenges and Future Directions</h4>
              <p className="text-lg text-gray-700 text-justify mb-6">
                Despite their vital work, Gender Law Clinics face challenges, including limited funding, low awareness of legal rights in some communities, and persistent cultural and patriarchal barriers that discourage individuals from seeking help. The future of these clinics relies on continued advocacy, sustainable funding models, and innovative approaches, such as integrating technology and expanding their reach to address emerging issues related to gender identity and sexual orientation.</p>

              <p>In essence, Gender Law Clinics are crucial institutions in the ongoing struggle for gender equality, acting as dynamic interfaces between academia, civil society, and the formal justice system to promote justice and human rights for all.</p>
            </div>
