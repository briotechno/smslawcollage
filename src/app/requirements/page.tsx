                    ...
                    <div className=" flex items-center gap-4 flex-wrap">
                      {req.file && (
                        <Link
                          href={req.file}
                          target="_blank"
                          className="w-full md:w-auto px-4 py-2 bg-purple-600 text-white rounded-md inline-flex items-center justify-center gap-2 hover:bg-purple-700 download-link transition-all duration-200"
                        >
