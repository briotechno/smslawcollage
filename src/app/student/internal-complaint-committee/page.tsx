        ...
        <div className="relative z-10 flex items-center h-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-3xl">
              ...
              >
                The Internal Complaints Committee (ICC) is constituted as per UGC Regulations, 2015,
                and the Sexual Harassment of Women at Workplace Act, 2013, to deal with complaints
                of sexual harassment at the educational institution.
              </motion.p>
            </div>
          </div>
        </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">icc@smslawcollege.edu</span>
                  </div>
                  <div className="flex items-center gap-3">
