    ...
    <AdminLayout title="Calendar Event Admin">
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div></div>
          <button
            className="w-full sm:w-auto bg-purple-600 text-white px-6 py-3 rounded-lg 
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">
              All Calendar Events ({filtered.length})
            </h3>
          </div>
          ...
          {filtered.length === 0 ? (
            ...
            <div className="flex flex-col gap-4">
              {filtered.map((event) => (
                <div
                  key={event.id}
                  className="bg-white rounded-lg shadow-sm p-4 border border-gray-100 flex flex-col gap-2 transition hover:shadow-md"
                >
                  {/* Title + Actions */}
                  <div className="flex items-center justify-between">
