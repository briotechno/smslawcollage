...
const EditCalendarEventClientPage = () => {
  ...
  return (
    <div>
      ...
      <form
        className="max-w-xl mx-auto bg-white shadow-lg rounded-lg p-8 flex flex-col gap-6"
      ...
      >
        ...
        <div className="flex justify-end gap-3 mt-8">
          ...
          <button
            type="submit"
            className={`bg-purple-600 text-white px-6 py-3 rounded font-semibold text-lg flex items-center justify-center gap-2 ${
              loading ? "opacity-70 cursor-wait" : "hover:bg-purple-700"
            }`}
            disabled={loading}
          >
            {loading ? (
...
export default EditCalendarEventClientPage;
